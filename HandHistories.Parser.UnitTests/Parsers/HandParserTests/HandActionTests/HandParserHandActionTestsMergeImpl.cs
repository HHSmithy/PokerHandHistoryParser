...
namespace HandHistories.Parser.UnitTests.Parsers.HandParserTests.HandActionTests
{
    ...
    class HandParserHandActionTestsMergeImpl : HandParserHandActionTests
    {
                ...
                return new List<HandAction>()
                           {
                               ...
                               new WinningsAction("nemi711", HandActionType.WINS, 59.5m, 0),                               
                           };
            }
        }
                ...
                return new List<HandAction>()
                           {
                               ...
                               new WinningsAction("anica11", HandActionType.WINS, 51.66m, 0),                               
                           };
            }
        }
                ...
                return new List<HandAction>()
                           {
                               ...
                               new WinningsAction("cashgreedy00", HandActionType.WINS, 11m, 0),                               
                           };
            }
        }
                ...
                return new List<HandAction>()
                           {
                               ...
                               new WinningsAction("dugaly", HandActionType.WINS, 21.74m, 1),                               
                               new WinningsAction("dugaly", HandActionType.WINS, 407.7m, 0)
                           };
            }
        }
        ...
        public void GameCancelledHand_Works()
        {
            ...
            TestParseActions("CancelledHand", expectedActions);
        }
    }
}
