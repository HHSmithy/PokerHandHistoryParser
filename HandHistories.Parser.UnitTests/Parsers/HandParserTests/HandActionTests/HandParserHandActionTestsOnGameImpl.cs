...
namespace HandHistories.Parser.UnitTests.Parsers.HandParserTests.HandActionTests
{
    ...
    class HandParserHandActionTestsOnGameImpl : HandParserHandActionTests
    {
        ...
        {
            get { return new List<WinningsAction>() { new WinningsAction("BONUS 1OOO", WinningsActionType.WINS, 3.80m, 0), }; }
        }
        ...
        {
            get { return new List<WinningsAction>() { new WinningsAction("kliketiklok", WinningsActionType.WINS, 1, 0) }; }
        }
        ...
        {
            get { return new List<WinningsAction>() { new WinningsAction("fyabcf", WinningsActionType.WINS, 4m, 0) }; }
        }
        ...
        {
            get { return new List<WinningsAction>() { new WinningsAction("fyabcf", WinningsActionType.WINS, 226.82m, 0), }; }
        }
        ...
        protected override List<WinningsAction> ExpectedWinnersOmahaHiLoHand
        {
            get
            {
                return new List<WinningsAction>() {
                    new WinningsAction("alikator21", WinningsActionType.WINS, 354.50m, 0),                               
                    new WinningsAction("McCall901", WinningsActionType.WINS, 354.50m, 0),         
                };
            }
        }
        ...
        public void PlayerNameWithDashes_Works()
        {
            ...
            {
                new WinningsAction("kliketiklok", WinningsActionType.WINS, 2.5m, 0),
            };

            TestParseActions("NameWithDashes", expectedActions, expectedWinners);
        }
    }
}
