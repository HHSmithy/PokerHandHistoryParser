                ...
                return new List<HandAction>()
                           {
                               ...
                               new WinningsAction("Nightfox82", HandActionType.WINS, 1.81m,0),
                ...
                return new List<HandAction>()
                           {
                               ...
                               new WinningsAction("jweeke", HandActionType.WINS, 2m, 0),
                ...
                return new List<HandAction>()
                           {
                               ...
                               new WinningsAction("LovID", HandActionType.WINS, 0.87m, 0),
