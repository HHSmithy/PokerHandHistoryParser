...
namespace HandHistories.Parser.UnitTests.Parsers.HandParserTests.HandActionTests
{
    ...
    class HandParserHandActionTestsIPokerImpl : HandParserHandActionTests
    {
        ...
        {
            get { return new List<WinningsAction>() { new WinningsAction("Dullaghan", WinningsActionType.WINS, 1.61m, 0), }; }
        }
        ...
        {
            get { return new List<WinningsAction>() { new WinningsAction("Blemishers", WinningsActionType.WINS, 0.15m, 0), }; }
        }
        ...
        {
            get { return new List<WinningsAction>() { new WinningsAction("Amalfitano1", WinningsActionType.WINS, 18.28m, 0), }; }
        }
        ...
        protected override List<WinningsAction> ExpectedWinnersHandActionsAllInHand
        {
            get
            {
                ...
                { 
                    new WinningsAction("Amalfitano1", WinningsActionType.WINS, 17.55m, 0),
                    new WinningsAction("Taras2107", WinningsActionType.WINS, 3.18m, 0), 
                };
            }
        }
        ...
        public void AllInHand_WithAction7_Works()
        {
            ...
            {
                new WinningsAction("bf324846", WinningsActionType.WINS, 9.28m, 0)
            };

            TestParseActions("AllInHandWithShowdown2", expectedActions, expectedWinners);
        }
        ...
        public void AnteParsingTest_Fixed()
        {
            ...
            var expectedWinners = new List<WinningsAction>()
            {
               new WinningsAction("WWR141388412", WinningsActionType.WINS, 0.35m, 0),
            };

            TestParseActions("AnteAction", expectedActions, expectedWinners);
        }
        ...
        public void PostingDeadParsingTest_Works()
        {
            ...
            var expectedWinners = new List<WinningsAction>()
            {
               new WinningsAction("Player5", WinningsActionType.WINS, 140m, 0),
            };
