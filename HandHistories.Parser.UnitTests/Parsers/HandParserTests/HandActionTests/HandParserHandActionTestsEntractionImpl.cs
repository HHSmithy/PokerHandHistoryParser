                 ...
                 return new List<HandAction>()
                           {
                               ...
                               new WinningsAction("pauli1", HandActionType.WINS, 27.25m, 0),                               
                           };
             }
         }
                 ...
                 return new List<HandAction>()
                           {
                               ...
                               new HandAction("NO12", HandActionType.UNCALLED_BET, 25, Street.Preflop),     
                                new WinningsAction("NO12", HandActionType.WINS, 50, 0),                             
                           };
             }
         }
                 ...
                 return new List<HandAction>()
                           {
                               ...
                               new WinningsAction("stook", HandActionType.WINS, 23.04m, 0),                               
                           };
             }
         }
                 ...
                 return new List<HandAction>()
                           {
                               ...
                               new WinningsAction("bglegend22", HandActionType.WINS, 5898.50m, 0),                             
                           };
             }
         }
                 ...
                 return new List<HandAction>()
                           {
                               ...
                               new WinningsAction("YoOyYo", HandActionType.WINS, 999.25m, 0),                               
                               new WinningsAction("Ballyhoo", HandActionType.WINS, 999.25m, 0),   
                           };
             }
         }
